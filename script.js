...
const translations = {
  ...
  en: {
    ...
    chat: {
      ...
      status: 'Quick replies and simple guidance.',
      inputLabel: 'Write your message',
      placeholder: 'Tell me quickly what you need.',
      submit: 'Send',
      whatsapp: 'WhatsApp',
      form: 'Form',
      closeAria: 'Close chat',
      welcome: 'Hi. I can help you with your website, ads, messages, or automations in a simple way.',
      thinking: 'Thinking...',
      ...
      quickActions: ['I want a website', 'I want more sales', 'I need help with messages', 'I want to talk to someone'],
      lead: {
        title: 'Leave your details',
        text: 'If you want, we can reply with a simple and clear recommendation.',
        name: 'Your name',
        email: 'you@company.com',
        company: 'Company (optional)',
        submit: 'Contact me',
        prompt: 'If you want to move forward, leave your name and email and we will reply clearly and quickly.',
